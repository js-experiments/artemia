...
Lawnchair.prototype = {
	...
	init:function(opts) {
		var adaptors = {
            ...
            'jqcouch':window.jqueryCouchAdaptor
		};
    ...
    //return all document selected by a map function (only use with jqueryCouchAdaptor)
    query:function(map,callback) {
        if(this.adaptor.name=='jqueryCouchAdaptor'){
            this.adaptor.query(map, callback)
        }else{throw("query() method is functional only for jqueryCouchAdaptor");}
