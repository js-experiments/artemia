var artemia=function(e){function i(f,j){return{storeType:j,storeName:f,dataBase:null,isAvailable:function(){try{var a=this;artemia[f]||(artemia[f]=window.openDatabase("Artemia","1.0","ARTEMIADB",65536));this.dataBase=artemia[f];this.dataBase.transaction(function(b){b.executeSql("CREATE TABLE IF NOT EXISTS  "+a.storeName+"(UniqueId TEXT UNIQUE PRIMARY KEY,SerializedObject TEXT)",[],null,null)})}catch(b){if(b===2)throw"Invalid database version";else throw"Unknown error "+b;}return!0},save:function(a,
